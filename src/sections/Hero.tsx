...
function Hero() {
  return (
    <div className={styles.hero}>
      ...
      <motion.h2
        className={styles.heroTitle__large}
        initial={{ opacity: 0, y: 5 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          duration: 0.3,
      ...
      <motion.h3
        className={`${styles.heroTitle__large} ${styles.heroTitle__sub}`}
        initial={{ opacity: 0, y: 5 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          duration: 0.3,
      ...
      >
        ...
        <Link href="https://rapidops.com" target="_blank" className={styles.link}>
          Melo Dev.
        </Link>
      </motion.p>
      <motion.div
